...
c.Authenticator.allowed_users = {"simon"}

c.JupyterHub.spawner_class = 'dockerspawner.DockerSpawner'

# Choose a default image
c.DockerSpawner.image = 'jupyter/base-notebook:python-3.11'

# (optional) Allow users to pick from a list of images
c.DockerSpawner.allowed_images = {
    "Python 3.11 + SciPy": "jupyter/scipy-notebook:python-3.11",
    "GPU ML Stack": "myregistry.local/ml-gpu:latest",
...
#  Default: '/home/simon/miniconda3/envs/jhub/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/simon/miniconda3/envs/jhub/share/jupyterhub'
